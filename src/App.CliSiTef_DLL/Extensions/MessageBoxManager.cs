...
namespace System.Windows.Forms
{
    public class MessageBoxManager
    {
        ...
        public static void Register()
        {
            ...
            //int currentTheradId = AppDomain.GetCurrentThreadId();
            int managerThreadId = Process.GetCurrentProcess().Threads[0].Id;
            hHook = SetWindowsHookEx(WH_CALLWNDPROCRET, hookProc, IntPtr.Zero, managerThreadId);
        }
