    ...
    public class RedeAutorizadora
    {
        public static List<RedeAutorizadoraConst> RetornarLista()
        {
            return new List<RedeAutorizadoraConst>()
            {
                ...
                new RedeAutorizadoraConst() { Codigo = "00274", Nome = "MAXXICARD" },
                ...
                new RedeAutorizadoraConst() { Codigo = "00279", Nome = "REDE SODEXO" },
                new RedeAutorizadoraConst() { Codigo = "00280", Nome = "KREDILIG" },
                new RedeAutorizadoraConst() { Codigo = "00282", Nome = "GETCARD" },
                new RedeAutorizadoraConst() { Codigo = "00283", Nome = "CONDUCTOR DUP" },
                new RedeAutorizadoraConst() { Codigo = "00284", Nome = "FTC" },
                new RedeAutorizadoraConst() { Codigo = "00285", Nome = "CSF BUREAU" },
                new RedeAutorizadoraConst() { Codigo = "00286", Nome = "FIDELIDADE BRADESCO" },
                new RedeAutorizadoraConst() { Codigo = "00287", Nome = "ECARDES" },
                new RedeAutorizadoraConst() { Codigo = "00289", Nome = "MAXIS CARD" },
                new RedeAutorizadoraConst() { Codigo = "00290", Nome = "ELAVON MEXICO" },
                new RedeAutorizadoraConst() { Codigo = "00291", Nome = "APTARE" },
                new RedeAutorizadoraConst() { Codigo = "00292", Nome = "TA PAGO" },
                new RedeAutorizadoraConst() { Codigo = "00293", Nome = "PAYNET" },
                new RedeAutorizadoraConst() { Codigo = "00294", Nome = "PLANTAO CARD" },
                new RedeAutorizadoraConst() { Codigo = "00295", Nome = "DISCOVERCARD" },
                new RedeAutorizadoraConst() { Codigo = "00296", Nome = "SAFRA" },
                new RedeAutorizadoraConst() { Codigo = "00297", Nome = "REDE TICKET" },
                new RedeAutorizadoraConst() { Codigo = "00299", Nome = "ZICARD" },
                new RedeAutorizadoraConst() { Codigo = "00300", Nome = "HS HERVAL" },
                new RedeAutorizadoraConst() { Codigo = "00301", Nome = "CTF FROTA" },
                new RedeAutorizadoraConst() { Codigo = "00302", Nome = "PAGSEGURO" },
                new RedeAutorizadoraConst() { Codigo = "00303", Nome = "SIPAG" },
                new RedeAutorizadoraConst() { Codigo = "00304", Nome = "ITSPAY" },
                new RedeAutorizadoraConst() { Codigo = "00305", Nome = "TO_REDECARD" },
                new RedeAutorizadoraConst() { Codigo = "00306", Nome = "VACINA" },
                new RedeAutorizadoraConst() { Codigo = "00307", Nome = "4ALL" },
                new RedeAutorizadoraConst() { Codigo = "00308", Nome = "STARKCARD" },
                new RedeAutorizadoraConst() { Codigo = "00309", Nome = "ADIQ" },
                new RedeAutorizadoraConst() { Codigo = "00310", Nome = "PICPAY" },
                new RedeAutorizadoraConst() { Codigo = "00311", Nome = "DATA_ENTER_TB" },
                new RedeAutorizadoraConst() { Codigo = "00312", Nome = "ULTRAGAZ-REVENDA" },
                new RedeAutorizadoraConst() { Codigo = "00313", Nome = "VIACERTA" },
                new RedeAutorizadoraConst() { Codigo = "00314", Nome = "DATA_ENTER_VI" },
                new RedeAutorizadoraConst() { Codigo = "00315", Nome = "SOFTBOX" },
                new RedeAutorizadoraConst() { Codigo = "00316", Nome = "DATA_ENTER_AMEX" },
                new RedeAutorizadoraConst() { Codigo = "00317", Nome = "SIPPE SIPAG" },
                new RedeAutorizadoraConst() { Codigo = "00318", Nome = "AVBR" },
                new RedeAutorizadoraConst() { Codigo = "00322", Nome = "CYBERSOURCE" },
                new RedeAutorizadoraConst() { Codigo = "00325", Nome = "BOLT" },
                new RedeAutorizadoraConst() { Codigo = "00327", Nome = "BRADESCARD MEXICO" },
                new RedeAutorizadoraConst() { Codigo = "00328", Nome = "CAIXA PAGAMENTOS" },
                new RedeAutorizadoraConst() { Codigo = "00401", Nome = "ARQEXP_TB" },
                new RedeAutorizadoraConst() { Codigo = "00404", Nome = "ARQEXP_VI" },
                new RedeAutorizadoraConst() { Codigo = "00405", Nome = "ARQEXP_RD" },
                new RedeAutorizadoraConst() { Codigo = "00406", Nome = "ARQEXP_AMEX" },
                new RedeAutorizadoraConst() { Codigo = "00421", Nome = "ARQEXP_BANRISUL" },
                new RedeAutorizadoraConst() { Codigo = "00429", Nome = "ARQEXP_SOFTWAY" },
                new RedeAutorizadoraConst() { Codigo = "00442", Nome = "EPAY" },
                new RedeAutorizadoraConst() { Codigo = "00447", Nome = "ARQEXP_SOROCRED" },
                new RedeAutorizadoraConst() { Codigo = "00451", Nome = "ARQEXP_HIPERCARD" },
                new RedeAutorizadoraConst() { Codigo = "00452", Nome = "TRICARD" },
                new RedeAutorizadoraConst() { Codigo = "00454", Nome = "ARQEXP_POLICARD" },
                new RedeAutorizadoraConst() { Codigo = "00468", Nome = "ARQEXP_BANESE" },
                new RedeAutorizadoraConst() { Codigo = "00472", Nome = "BIGCARD" },
                new RedeAutorizadoraConst() { Codigo = "00477", Nome = "VALECARD" },
                new RedeAutorizadoraConst() { Codigo = "00482", Nome = "GETNET" },
                new RedeAutorizadoraConst() { Codigo = "00493", Nome = "AURA" },
                new RedeAutorizadoraConst() { Codigo = "00494", Nome = "CABAL" },
                new RedeAutorizadoraConst() { Codigo = "00525", Nome = "CIELO" },
                new RedeAutorizadoraConst() { Codigo = "00553", Nome = "PAGGO" },
                new RedeAutorizadoraConst() { Codigo = "00606", Nome = "GLOBAL PAYMENTS" },
                new RedeAutorizadoraConst() { Codigo = "00607", Nome = "ELAVON" },
                new RedeAutorizadoraConst() { Codigo = "00665", Nome = "STONEWS" },
                new RedeAutorizadoraConst() { Codigo = "00671", Nome = "CARDSE" },
                new RedeAutorizadoraConst() { Codigo = "00709", Nome = "ADIQ" },
                new RedeAutorizadoraConst() { Codigo = "00801", Nome = "CB_BB" },
                new RedeAutorizadoraConst() { Codigo = "00802", Nome = "CB_INTERCHANGE" },
                new RedeAutorizadoraConst() { Codigo = "00805", Nome = "CB_BRADESCO" },
                new RedeAutorizadoraConst() { Codigo = "00807", Nome = "CB_BANESPA" },
                new RedeAutorizadoraConst() { Codigo = "00808", Nome = "CB_HSBC" },
                new RedeAutorizadoraConst() { Codigo = "00810", Nome = "CB_GENERICO" },
                new RedeAutorizadoraConst() { Codigo = "00812", Nome = "CB_ITAU" },
                new RedeAutorizadoraConst() { Codigo = "00813", Nome = "CB_CORBANSE-TRIBANCO" },
                new RedeAutorizadoraConst() { Codigo = "00849", Nome = "CIELO ECOMMERCE" },
                new RedeAutorizadoraConst() { Codigo = "00851", Nome = "EREDE" },
                new RedeAutorizadoraConst() { Codigo = "00852", Nome = "NPC" },
                new RedeAutorizadoraConst() { Codigo = "00853", Nome = "GETNET-GW" },
                new RedeAutorizadoraConst() { Codigo = "00854", Nome = "PAYPAL" },
                new RedeAutorizadoraConst() { Codigo = "00855", Nome = "SAFATYPAY" },
                new RedeAutorizadoraConst() { Codigo = "00856", Nome = "SAFRA-HUB" },
                new RedeAutorizadoraConst() { Codigo = "00857", Nome = "ESITEF" },
                new RedeAutorizadoraConst() { Codigo = "00858", Nome = "ALELO" },
                new RedeAutorizadoraConst() { Codigo = "00859", Nome = "POS BIN" },
                new RedeAutorizadoraConst() { Codigo = "00860", Nome = "MERCADO PAGO" },
                new RedeAutorizadoraConst() { Codigo = "00861", Nome = "RAPPI" },
                new RedeAutorizadoraConst() { Codigo = "00901", Nome = "PINPAD" },
                new RedeAutorizadoraConst() { Codigo = "00999", Nome = "POS" }
            };
        }
